...
def start_testing():
    ...
    # Create a label to display the divisions of the screen
    divisions_label = tk.Label(window, text="Screen Divisions (Segments):", font=("Arial", 14), bg='#D6EAF8', fg='#154360')
    divisions_label.pack(pady=10)

    # Create a table to display the divisions
    ...
    stop_button = tk.Button(window, text="Stop Testing", font=("Arial", 16), bg='#E74C3C', fg='#FFFFFF', command=window.destroy)
    stop_button.pack(pady=20)

# Add the start button and center it in the window
